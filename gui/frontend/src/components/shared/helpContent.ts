    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { term: 'SSI (Stress–Strength Interference)', def: 'Enter stress and strength distributions with parameters, compute P(failure) = P(stress > strength) via numerical integration, and visualize the interference diagram.' },
        ],
      },
      {
        heading: 'Inputs',
