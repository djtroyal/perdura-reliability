    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'For lasso and elastic net, Selection stability runs a separate complementary-half-sample selector over a penalty path; it does not assess the full-sample alpha fit. Perdura chooses one operating lambda whose empirical selection size q meets a plug-in PFER diagnostic target, then reports selection frequencies at that lambda. The plug-in quantity is not a formal false-selection bound, and stable classifications are withheld if any base refit fails. Elastic Net requires an L1 ratio above zero for this selector.',
