...
const MIL_ITEMS: PaletteItem[] = [
  ...
  { id: 'mil-bubble', label: 'Magnetic Bubble Memory', category: 'bubble_memory', group: 'Microcircuits', Icon: MemoryStick, color: 'text-violet-400' },

  { id: 'mil-diode', label: 'Low-Frequency Diode', category: 'diode', group: 'Discrete Semiconductors', Icon: Triangle, color: 'text-rose-500' },
  { id: 'mil-hf-diode', label: 'High-Frequency Diode', category: 'hf_diode', group: 'Discrete Semiconductors', Icon: Triangle, color: 'text-rose-400' },
  { id: 'mil-bjt', label: 'Low-Frequency BJT', category: 'bjt', group: 'Discrete Semiconductors', Icon: Radio, color: 'text-emerald-500' },
  { id: 'mil-fet', label: 'Low-Frequency Si FET', category: 'fet', group: 'Discrete Semiconductors', Icon: Radio, color: 'text-teal-500' },
  { id: 'mil-uni', label: 'Unijunction Transistor', category: 'unijunction', group: 'Discrete Semiconductors', Icon: Radio, color: 'text-emerald-400' },
  { id: 'mil-hf-ln-bjt', label: 'HF Low-Noise BJT', category: 'hf_low_noise_bjt', group: 'Discrete Semiconductors', Icon: Radio, color: 'text-emerald-600' },
  { id: 'mil-hf-pwr-bjt', label: 'HF Power BJT', category: 'hf_power_bjt', group: 'Discrete Semiconductors', Icon: Radio, color: 'text-emerald-700' },
  { id: 'mil-gaas-fet', label: 'HF GaAs FET', category: 'gaas_fet', group: 'Discrete Semiconductors', Icon: Radio, color: 'text-teal-400' },
  { id: 'mil-hf-si-fet', label: 'HF Silicon FET', category: 'hf_silicon_fet', group: 'Discrete Semiconductors', Icon: Radio, color: 'text-teal-600' },
  { id: 'mil-thyristor', label: 'Thyristor / SCR', category: 'thyristor', group: 'Discrete Semiconductors', Icon: Zap, color: 'text-amber-500' },
  { id: 'mil-opto', label: 'Optoelectronic / Display', category: 'optoelectronic', group: 'Discrete Semiconductors', Icon: Lightbulb, color: 'text-yellow-500' },
  { id: 'mil-laser-diode', label: 'Laser Diode', category: 'laser_diode', group: 'Discrete Semiconductors', Icon: Activity, color: 'text-red-400' },

  { id: 'mil-tube', label: 'Electron Tube', category: 'electron_tube', group: 'Tubes & Lasers', Icon: MonitorSpeaker, color: 'text-orange-600' },
  { id: 'mil-twt', label: 'Traveling-Wave Tube', category: 'traveling_wave_tube', group: 'Tubes & Lasers', Icon: MonitorSpeaker, color: 'text-orange-500' },
  { id: 'mil-magnetron', label: 'Magnetron', category: 'magnetron', group: 'Tubes & Lasers', Icon: Waves, color: 'text-orange-700' },
  { id: 'mil-gas-laser', label: 'Helium / Argon Laser', category: 'gas_laser', group: 'Tubes & Lasers', Icon: Activity, color: 'text-red-400' },
  { id: 'mil-sealed-co2', label: 'Sealed CO₂ Laser', category: 'sealed_co2_laser', group: 'Tubes & Lasers', Icon: Activity, color: 'text-red-500' },
  { id: 'mil-flowing-co2', label: 'Flowing CO₂ Laser', category: 'flowing_co2_laser', group: 'Tubes & Lasers', Icon: Activity, color: 'text-red-600' },
  { id: 'mil-solid-laser', label: 'Solid-State Laser', category: 'solid_state_laser', group: 'Tubes & Lasers', Icon: Activity, color: 'text-red-700' },

  { id: 'mil-resistor', label: 'Resistor', category: 'resistor', group: 'Passives', Icon: RectangleHorizontal, color: 'text-orange-500' },
  { id: 'mil-capacitor', label: 'Capacitor', category: 'capacitor', group: 'Passives', Icon: Battery, color: 'text-sky-500' },
  { id: 'mil-transformer', label: 'Transformer', category: 'transformer', group: 'Passives', Icon: Magnet, color: 'text-purple-600' },
  { id: 'mil-coil', label: 'Inductor / Coil', category: 'inductor_coil', group: 'Passives', Icon: Magnet, color: 'text-purple-500' },
  { id: 'vita-ferrite-bead', label: 'Ferrite Bead (A/V51.1)', category: 'ferrite_bead', group: 'Passives', Icon: Magnet, color: 'text-purple-400' },
  { id: 'mil-crystal', label: 'Quartz Crystal', category: 'crystal', group: 'Passives', Icon: Diamond, color: 'text-fuchsia-500' },
  { id: 'vita-oscillator', label: 'Oscillator (A/V51.1)', category: 'oscillator', group: 'Passives', Icon: Diamond, color: 'text-fuchsia-400' },
  { id: 'vita-mems-oscillator', label: 'MEMS Oscillator (A/V51.1)', category: 'mems_oscillator', group: 'Passives', Icon: Cpu, color: 'text-violet-400' },
  { id: 'mil-filter', label: 'Electronic Filter', category: 'filter', group: 'Passives', Icon: Filter, color: 'text-violet-500' },

  { id: 'mil-motor', label: 'Motor (<1 hp)', category: 'motor', group: 'Electromechanical', Icon: Fan, color: 'text-green-500' },
  { id: 'mil-synchro', label: 'Synchro / Resolver', category: 'synchro_resolver', group: 'Electromechanical', Icon: Cog, color: 'text-green-600' },
  { id: 'mil-etm', label: 'Elapsed-Time Meter', category: 'elapsed_time_meter', group: 'Electromechanical', Icon: Gauge, color: 'text-slate-500' },
  { id: 'mil-relay', label: 'Mechanical Relay', category: 'relay', group: 'Electromechanical', Icon: ToggleRight, color: 'text-cyan-500' },
  { id: 'mil-ss-relay', label: 'Solid-State Relay', category: 'ss_relay', group: 'Electromechanical', Icon: ToggleRight, color: 'text-cyan-400' },
  { id: 'mil-switch', label: 'Switch', category: 'switch', group: 'Electromechanical', Icon: ToggleLeft, color: 'text-blue-500' },
  { id: 'mil-breaker', label: 'Circuit Breaker', category: 'circuit_breaker', group: 'Electromechanical', Icon: Shield, color: 'text-blue-600' },
  { id: 'mil-lamp', label: 'Incandescent Lamp', category: 'lamp', group: 'Electromechanical', Icon: Lightbulb, color: 'text-amber-400' },

  { id: 'mil-connector', label: 'Connector', category: 'connector', group: 'Interconnect', Icon: Plug, color: 'text-lime-600' },
  { id: 'mil-socket', label: 'Connector Socket', category: 'connector_socket', group: 'Interconnect', Icon: Plug, color: 'text-lime-500' },
  { id: 'mil-pth', label: 'PTH Assembly', category: 'pth_assembly', group: 'Interconnect', Icon: CircuitBoard, color: 'text-emerald-600' },
  { id: 'mil-smt', label: 'Surface-Mount Assembly', category: 'surface_mount_assembly', group: 'Interconnect', Icon: CircuitBoard, color: 'text-emerald-500' },
  { id: 'mil-connection', label: 'Single Connection', category: 'connection', group: 'Interconnect', Icon: Cable, color: 'text-stone-500' },

  { id: 'mil-meter', label: 'Panel Meter', category: 'meter', group: 'Other', Icon: Gauge, color: 'text-slate-500' },
  { id: 'mil-fuse', label: 'Fuse', category: 'fuse', group: 'Other', Icon: Zap, color: 'text-red-500' },
  { id: 'mil-misc', label: 'Miscellaneous Part', category: 'miscellaneous', group: 'Other', Icon: Disc, color: 'text-gray-500' },
  { id: 'mil-parts-count', label: 'Appendix A Parts Count', category: 'parts_count', group: 'Other', Icon: CircuitBoard, color: 'text-slate-600' },
  { id: 'mil-custom', label: 'Custom λ', category: 'custom', group: 'Other', Icon: Box, color: 'text-gray-400' },
]
...
export const PALETTE_GROUP_ORDER = [
  'Microcircuits', 'Semiconductors', 'Discrete Semiconductors', 'Tubes & Lasers', 'Passives',
