...
const predictionTopics: HelpTopic[] = [
  ...
  workflowTopic({
    ...
    assumptions: ['The chosen BOM columns have the meanings assigned in the import wizard.', 'Regex matches are classification evidence, not proof that a handbook category or default parameter is correct.'],
    ...
    caution: 'Do not bulk-confirm mappings solely because their confidence is high. Regulatory or design-review use requires verification of the component family, exact handbook model, defaulted parameters, source file, and active rule revision.',
  ...
  workflowTopic({
    ...
    interpretation: ['Class S and Class B are 217F quality-factor families.', 'The supplied 2019 MIL-STD-883 Parts 1–5 and 2025 change are later method context, not proof of exact 1995-edition parity.'],
    caution: 'Do not infer a 217F factor from a modern product-class name alone. Screening method, revision, flow, and actual lot controls must support the selected bucket.',
  ...
  mathTopic({
    ...
    advanced: [
      ...
      'Unsupported modern technologies remain explicit. Perdura does not substitute the operating model or apply a generic percentage credit.',
  ...
  workflowTopic({
    ...
    caution: 'Do not substitute a generic family limit for a source rule that depends on subtype, quality, mission duration, rated temperature, transients, or an exception list. Historical-source parity is not current-agency approval.', citations: [cite('mil-std-975m-derating'), cite('mil-hdbk-978b-resistor'), cite('radc-tr-84-254-derating'), cite('rl-tr-92-11-derating'), cite('mil-std-198e-capacitor'), cite('rome-derating-toolkit'), cite('mil-hdbk-338b-derating'), cite('ecss-derating')], related: ['prediction.part-stress'],
