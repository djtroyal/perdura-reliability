...
const systemTopics: HelpTopic[] = [
  mathTopic({
    moduleId: 'systemModeling', id: 'rbd', title: 'Reliability Block Diagram', aliases: ['RBD', 'success path', 'Birnbaum importance', 'RAW', 'RRW'],
    summary: 'Builds and exactly evaluates a directed success-path network, with component life models, beta-factor common cause, time projection, model diagnostics, and importance measures.',
    useWhen: ['System success is naturally expressed by one or more functioning source-to-sink paths.', 'You need to compare series bottlenecks, redundant alternatives, or architecture sensitivity.'], inputs: ['One source and one sink', 'Reliability blocks and directed left-to-right connections', 'Direct mission reliability or a supported life distribution for every block', 'Optional system mission time and beta-factor common-cause groups'],
