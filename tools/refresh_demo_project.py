...
MTA_DEMO_STATE: dict[str, Any] = {
    ...
    "personnel": [{
        ...
        "weekly_shifts": [
            {"weekday": day, "start_hour": 7, "end_hour": 15, "capacity": 2}
            for day in range(5)
        ],
        "planned_outages": [],
    }],
    ...
    "tasks": [{
        ...
        "description": (
            "Corrective field task linked to loss of coolant-pump function. "
            "The worked case demonstrates dependency, uncertainty, labor, "
            "renewable equipment, spares, downtime, and validation evidence."
        ),
        ...
        "frequency": {
            ...
            "tolerance_after_hours": 8,
        },
        "steps": [
            {
                "id": "S1", "label": "Prepare and isolate equipment",
                "description": "", "action_verb": "isolate",
                "object": "coolant subsystem", "qualifiers": "",
                "phase": "isolate", "predecessor_step_ids": [],
                "duration": {
                    "mode": "fixed", "fixed_hours": 0.5,
                    "distribution": "pert", "optimistic_hours": 0.5,
                    "most_likely_hours": 0.5, "pessimistic_hours": 0.5,
                },
                "execution_probability": 1, "branch_group": "",
                "interruptible": True,
                "personnel": [{
                    "role_id": "maint-tech", "headcount": 1,
                    "engagement_fraction": 1,
                }],
                "resources": [],
                "safety_precautions": (
                    "Isolate electrical power and relieve coolant pressure."
                ),
                "technical_data": "Approved coolant-pump replacement procedure",
                "acceptance_criteria": "Zero-energy state verified.",
            },
            {
                "id": "S2", "label": "Diagnose pump failure",
                "description": "", "action_verb": "diagnose",
                "object": "coolant pump", "qualifiers": "",
                "phase": "diagnose", "predecessor_step_ids": ["S1"],
                "duration": {
                    "mode": "uncertain", "fixed_hours": 1,
                    "distribution": "pert", "optimistic_hours": 0.5,
                    "most_likely_hours": 1, "pessimistic_hours": 3,
                },
                "execution_probability": 1, "branch_group": "",
                "interruptible": True,
                "personnel": [{
                ...
                "resources": [{
                    "resource_id": "portable-test-set", "quantity": 1,
                }],
                "safety_precautions": "", "technical_data": "",
                "acceptance_criteria": "Failed pump is isolated to one replaceable item.",
            },
            {
                "id": "S3", "label": "Replace failed pump",
                "description": "", "action_verb": "replace",
                "object": "coolant pump", "qualifiers": "",
                "phase": "replace", "predecessor_step_ids": ["S2"],
                "duration": {
                    "mode": "uncertain", "fixed_hours": 2,
                    "distribution": "pert", "optimistic_hours": 1.5,
                    "most_likely_hours": 2, "pessimistic_hours": 4,
                },
                "execution_probability": 1, "branch_group": "",
                "interruptible": True,
                "personnel": [{
                    "role_id": "maint-tech", "headcount": 2,
                    "engagement_fraction": 1,
                }],
                "resources": [{"resource_id": "pump-kit", "quantity": 1}],
                "safety_precautions": "", "technical_data": "",
                "acceptance_criteria": "Pump installed and connections secured.",
            },
            {
                "id": "S4", "label": "Test and restore equipment",
                "description": "", "action_verb": "verify",
                "object": "coolant-system operation", "qualifiers": "",
                "phase": "test", "predecessor_step_ids": ["S3"],
                "duration": {
                    "mode": "fixed", "fixed_hours": 0.75,
                    "distribution": "pert", "optimistic_hours": 0.75,
                    "most_likely_hours": 0.75, "pessimistic_hours": 0.75,
                },
                "execution_probability": 1, "branch_group": "",
                "interruptible": True,
                "personnel": [{
                ...
                "safety_precautions": "", "technical_data": "",
                "acceptance_criteria": (
                    "No leakage; flow and pressure within technical limits."
                ),
            },
        ],
        ...
        "hazards": (
            "Stored electrical and hydraulic energy; coolant exposure."
        ),
        "environment": "Field maintenance bay",
        "training_requirements": "Qualified mechanical maintainer",
        "validation_records": [{
            "id": "VAL-001", "kind": "procedure_walkthrough",
            "date": "2026-07-12", "outcome": "passed",
            "evidence": (
                "Walkthrough confirmed sequence, tooling, and safety controls."
            ),
            "reviewer": "Demo review team",
        }],
        "approval_rationale": (
            "Representative demo task; approval is illustrative only."
        ),
    }],
    "portfolio": {
        "horizon_hours": 2160,
...
CURRENT_SLICE_EXAMPLES: dict[str, Any] = {
    ...
    "maintTaskAnalysis": MTA_DEMO_STATE,
    "maintVirtualAge": {
...
def expected_example_demo() -> dict[str, Any]:
    ...
    demo["modules"]["maintTaskAnalysis"] = MTA_DEMO_STATE
    demo.pop("version", None)
    demo.update({
        "app": "Perdura",
        "subtitle": "Reliability Engineering and Statistics Suite",
