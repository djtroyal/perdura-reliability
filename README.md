...
- **Descriptive Statistics** — summary statistics, frequency and contingency tables, run charts, box plots, histograms, and normality tests
...
- **Regression** — linear, polynomial, ridge, lasso, and logistic regression with fit statistics, diagnostics, and plain-English interpretation
